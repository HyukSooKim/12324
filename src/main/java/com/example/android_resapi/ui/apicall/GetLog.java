...
public class GetLog extends GetRequest {
    ...
    protected void onPreExecute() {
        try {
            ...
            Log.i(TAG,"urlStr="+urlStr+params); //url 문자열 생성
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                Tag thing = new Tag(jsonObject.getString("temperature"),
                                    jsonObject.getString("LEDS"),
                                    jsonObject.getString("DC_MOTOR"),
    ...
    class Tag {
        ...
        public Tag(String temp, String led, String dc, String time) {
            temperature = temp;
            LEDS = led;
            DC_MOTOR = dc;
            timestamp = time;
        ...
        public String toString() {
            return String.format("[%s] 온도: %s, LEDS: %s, DC: %s", timestamp, temperature,LEDS, DC_MOTOR);
        }
    }
}
